# -*- coding: utf-8 -*-
#--https://blog.csdn.net/qq_39377134/article/details/102871986
import torch
...
def compute_iou(X, Y):
    ...
    combine_area = ((lable_X + lable_Y) != 0).float()
    intersection_area = lable_X + lable_Y - combine_area
    

    return torch.sum(intersection_area)/torch.sum(combine_area)
